...
export default function Sidebar({ role = "internee" }: SidebarProps) {
  ...
  href: "/intern/leave-application",
  roles: ["internee"], // only visible to interns
  icon: FileText,
},
{
      label: "Profile",
  ...
  {
  label: "Leave Application",
  href: "/teamlead/leave-application",
  roles: ["teamlead"], // visible to team leads
  icon: FileText,
},
  {
    label: "Profile",
