...
const mockNotifications: Notification[] = [
  {
    ...
    message: "Ali Raza has requested leave from 1st Sep to 3rd Sep.",
    type: "info",
    read: false,
    time: "15 min ago",
  },
  {
    ...
    message: "Sara Khan was late today by 2 hours.",
    type: "warning",
    read: false,
    time: "1 hr ago",
  },
  {
    ...
    message: "New intern, Ahmed Ali, has joined the company.",
    type: "success",
    read: true,
    time: "Yesterday",
  },
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-xl font-semibold text-slate-800 flex items-center gap-2">
          <Bell className="w-5 h-5 text-blue-600" /> HR Notifications
        </h1>
