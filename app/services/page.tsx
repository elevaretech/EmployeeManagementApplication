...
//           Elevare Tech provides innovative technology solutions to help your business grow.
//         </p>
//       </section>
...
//                 >
//                   <motion.div whileHover={{ rotate: 15 }}>{service.icon}</motion.div>
...
//         <h2 className="text-3xl font-bold text-[#022f62] mb-4">Want to Work With Us?</h2>
//         <p className="text-gray-700 mb-6">
//           Let's discuss how our tech solutions can take your business to the next level.
//         </p>
//         <a
//           href="mailto:contact@yourcompany.com?subject=Service%20Inquiry"
