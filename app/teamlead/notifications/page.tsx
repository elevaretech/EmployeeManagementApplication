...
const mockNotifications: Notification[] = [
  {
    ...
    message: "Intern Ali Raza has completed the assigned task.",
    type: "success",
    read: false,
    time: "10 min ago",
  },
  {
    id: "2",
    title: "Task Update",
    message: "Sara Khan updated the status of a task to In Progress.",
    type: "info",
    read: false,
    time: "30 min ago",
  },
  {
    ...
    message: "The deadline for Project Alpha is 2 days away.",
    type: "warning",
    read: true,
    time: "2 hrs ago",
  },
  {
    id: "4",
    title: "New Policy from Admin",
    message: "Admin has shared an updated project management guideline.",
    type: "info",
    read: true,
    time: "5 hrs ago",
  },
